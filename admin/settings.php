...
<body class="bg-slate-50 dark:bg-slate-950 flex transition-colors duration-300 min-h-screen">
    ...
    <main class="flex-1 lg:ml-72 flex flex-col min-w-0 overflow-hidden">
        <header class="h-24 sticky top-0 z-40 bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-8 lg:px-12">
            <div>
                <h1 class="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Paramètres <span class="text-emerald-600">Généraux</span></h1>
        ...
        <div class="p-8 lg:p-12 max-w-4xl">
            ...
            <div class="glass-panel p-8 md:p-12 rounded-[3rem] shadow-sm">
                <form action="" method="POST" class="space-y-8">
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mb-6">Modifiez le nom qui apparaît comme expéditeur lors de l'envoi d'e-mails depuis la plateforme.</p>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="mail_from_name" id="mail_from_name" required 
                                ...
                                class="w-full px-6 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all font-medium"
                                placeholder="Ex: Support Samy Magadju">
                        </div>
                    </div>

                    <div class="pt-4">
                        <button type="submit" class="px-10 py-4 bg-emerald-600 text-white font-black rounded-2xl hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-600/20 active:scale-95 uppercase tracking-widest text-xs">
            ...
            <div class="mt-12 p-8 rounded-[2rem] bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800/50">
                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 rounded-xl bg-emerald-600 text-white flex items-center justify-center shrink-0 shadow-lg shadow-emerald-600/20">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    </div>
                    <div>
                        <h4 class="font-black text-emerald-900 dark:text-emerald-400 uppercase tracking-tight text-sm mb-1">Information</h4>
                        <p class="text-xs text-emerald-800/70 dark:text-emerald-400/70 leading-relaxed font-medium">
                            Cette modification s'applique instantanément à tous les e-mails envoyés par le système.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 glass-panel p-8 md:p-12 rounded-[3rem] shadow-sm">
                ...
                <p class="text-sm text-slate-500 mb-6">URL directe vers la page d'expédition de la newsletter.</p>
                <div class="flex flex-col md:flex-row items-center gap-4">
                    <input type="text" readonly value="<?php echo SITE_URL; ?>/admin/newsletter/envoyer" 
                    ...
                    <a href="<?php echo SITE_URL; ?>/admin/newsletter/envoyer" target="_blank" class="w-full md:w-auto px-8 py-4 bg-amber-600 text-white font-black rounded-2xl hover:bg-amber-700 transition-all shadow-lg shadow-amber-600/20 active:scale-95 uppercase tracking-widest text-xs flex items-center justify-center gap-2 whitespace-nowrap">
